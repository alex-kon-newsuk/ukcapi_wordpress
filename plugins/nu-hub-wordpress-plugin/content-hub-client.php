<?php
/**
 * @package Content Hub Client
 * @author Carlos Rodriguez
 * @version 1.0.0
 */
/*
Plugin Name: Content Hub Client
Author:      Carlos Rodriguez (Updated pcleaves@newscorp.com)
Description: Publish and subscribe to topics of the Content Hub and automatically broadcast received messages to other plugins.
Version:     1.0.0
*/
...
if (!class_exists('HubPlugin')) {
    ...
    class HubPlugin
    {
        ...
        function __construct()
        {
            ...
            add_action('admin_menu', array($this, 'hub_menu'));
        ...
        /**
         * Change the rate limit and retry policy of a callback URL subscribed to a topic.
         *
         * <ul>
         * <li>number of retries</li>
         * <li>seconds between each retry</li>
         * <li>maximum receive rate per second</li>
         * </ul>
         */
        function hub_change_delivery_policy()
        {
            $this->hubService->hub_change_delivery_policy(
                $_POST["topicName"],
                $_POST["maxReceiveRatePerSecond"],
                $_POST["numRetries"],
                $_POST["secondsBetweenRetries"]
            );
        }

        function hub_menu()
        {
            add_menu_page('Content Hub', 'Content Hub', 'administrator', 'hub', array($this, 'hub_main'));
        ...
        function hub_main()
        {
            ...
            require("content-hub-client-forms.php");
        }
